...
const layoutCol2 = { xs: 24, md: 8, xl: 8, xxl: 8 };

function CreateProductOfBill({ listProduct, myInfo, typeAction, isModalVisible, handleOk, handleCancel, createProductOfBillSelected, customerDetail, ...props }) {
  ...
  return (
    <>
      <CustomModal
        ...
        submitLabel={t("LUU")}
      >
        <Form id="form-modal" form={formCreateProductOfBill} onValuesChange={(fieldSelected, dataSelected) => onChangeForm(fieldSelected, dataSelected)} onFinish={onFinish}>
          <Row gutter={15}>
            <CustomSkeleton
              label={'Chọn sản phẩm'}
              name="productId"
